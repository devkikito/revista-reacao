...
const Sweepstake: AdvertisingSectionProps = {
  alt: "SORTEIO DA CANECA DA TV REAÇÃO SERÁ NO DIA 28 DE E ESSA SEMANA VAMOS SORTEAR O LIVRO – QUANDO ENTREGO A MINHA DOR – MARCELO VILAS BOAS & VILLANO",
  src: "/img/temp/sorteio/QUANDO_ENTREGO_MINHA_DOR.jpeg",
  title:
    "SORTEIO DA CANECA DA TV REAÇÃO SERÁ NO DIA 28 DE E ESSA SEMANA VAMOS SORTEAR O LIVRO – QUANDO ENTREGO A MINHA DOR – MARCELO VILAS BOAS & VILLANO",
  description:
    "SORTEIO DA CANECA DA TV REAÇÃO SERÁ NO DIA 28 DE E ESSA SEMANA VAMOS SORTEAR O LIVRO – QUANDO ENTREGO A MINHA DOR – MARCELO VILAS BOAS & VILLANO",
};
