...
const Sweepstake: AdvertisingSectionProps = {
  alt: "SORTEIO DA CANECA DA TV REAÇÃO SERÁ NO DIA 28 DE E ESSA SEMANA VAMOS SORTEAR O LIVRO – UM MOTORISTA ESPECIAL DE CARRETA – SUPERAÇÃO ALÉM DA ESTRADA – DE HERMES OLIVEIRA",
  src: "/img/temp/sorteio/LIVROS.png",
  title: "SORTEIO DA CANECA DA TV REAÇÃO SERÁ NO DIA 28 DE E ESSA SEMANA VAMOS SORTEAR O LIVRO – UM MOTORISTA ESPECIAL DE CARRETA – SUPERAÇÃO ALÉM DA ESTRADA – DE HERMES OLIVEIRA",
  description: "SORTEIO DA CANECA DA TV REAÇÃO SERÁ NO DIA 28 DE E ESSA SEMANA VAMOS SORTEAR O LIVRO – UM MOTORISTA ESPECIAL DE CARRETA – SUPERAÇÃO ALÉM DA ESTRADA – DE HERMES OLIVEIRA.",
};
